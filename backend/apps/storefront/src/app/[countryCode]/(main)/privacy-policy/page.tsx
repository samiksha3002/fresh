...
export const metadata: Metadata = {
  title: "Privacy Policy | Kovea Touch",
  description: "Read the privacy policy for Kovea Touch.",
}

export default function PrivacyPolicyPage() {
  return (
    <div className="py-16 md:py-24 max-w-4xl mx-auto px-6 font-sans">
      <h1 className="text-3xl md:text-4xl font-medium text-gray-900 mb-6 text-center tracking-wide">
        Privacy Policy
      </h1>
      ...
      <div className="text-gray-600 leading-relaxed space-y-8 text-sm md:text-base">
        
        {/* INTRODUCTION */}
        <section className="space-y-4">
          <p>
            This Privacy Policy describes how Rsskincare (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from rsskincare.com (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
          <p>
        ...
        {/* CHANGES */}
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Changes to This Privacy Policy</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">How We Collect and Use Your Personal Information</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">What Personal Information We Collect</h2>
          <p>
        ...
        <section className="space-y-4">
          <h3 className="text-base font-semibold text-gray-800">Information We Collect Directly from You</h3>
        ...
        <section className="space-y-4">
          <h3 className="text-base font-semibold text-gray-800">Information We Collect about Your Usage</h3>
          <p>
        ...
        <section className="space-y-4">
          <h3 className="text-base font-semibold text-gray-800">Information We Obtain from Third Parties</h3>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">How We Use Your Personal Information</h2>
          <ul className="list-disc pl-5 space-y-3">
            <li><strong>Providing Products and Services.</strong> We use your personal information to provide you with the Services in order to perform our contract with you, including to process your payments, fulfill your orders, to send notifications to you related to your account, purchases, returns, exchanges or other transactions, to create, maintain and otherwise manage your account, to arrange for shipping, facilitate any returns and exchanges and other features and functionalities related to your account. We may also enhance your shopping experience by enabling Shopify to match your account with other Shopify services that you may choose to use.</li>
        ...
        <section className="space-y-4">
          ...
          <p>
            Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" className="text-black underline" target="_blank" rel="noreferrer">Shopify's Cookie Policy</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
          </p>
          <p>
            Most browsers automatically accept Cookies by default, but you can choose to set your browser to remove or reject Cookies through your browser controls. Please keep in mind that removing or blocking Cookies can negatively impact your user experience and may cause some of the Services, including certain features and general functionality, to work incorrectly or no longer be available. Additionally, blocking Cookies may not completely prevent how we share information with third parties such as our advertising partners.
          </p>
          <p>
            Our website also recognizes the Global Privacy Control (GPC) signal, which enables you to opt-out of certain uses or disclosures of your information. If you notify us of your preference through GPC, we will treat such signal as a valid request to opt out of sharing / targeted advertising for the associated browser or device, and, if we are able to associate the device sending the signal to a Shopify account, we will apply the opt out request to the account as well. To learn more about Global Privacy Control, you can visit <a href="https://globalprivacycontrol.org/" className="text-black underline" target="_blank" rel="noreferrer">https://globalprivacycontrol.org/</a>. Other than the Global Privacy Control, we do not recognize other “Do Not Track” signals that may be sent from your web browser or device.
          </p>
        </section>

        {/* HOW WE DISCLOSE */}
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">How We Disclose Personal Information</h2>
          <p>
            ...
            <table className="min-w-full border-collapse border border-gray-200 text-sm text-left">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-2 font-semibold">Category</th>
                  <th className="border border-gray-200 px-4 py-2 font-semibold">Categories of Recipients</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-200 px-4 py-2">Identifiers such as basic contact details and certain order and account information. Personal information categories listed in the California Customer Records statute. Commercial information such as order information, shopping information and customer support information. Internet or other similar network activity, such as Usage Data. Geolocation data such as locations determined by an IP address or other technical measures.</td>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">User Generated Content</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Third Party Websites and Links</h2>
          <p>
        ...
        {/* CHILDRENS DATA */}
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Children's Data</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Security and Retention of Your Information</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">Complaints & International Users</h2>
          <p>
            If you have complaints about how we process your personal information, please contact us using the contact details provided below. If you are not satisfied with our response to your complaint, depending on where you live you may have the right to appeal our decision by contacting us, or lodge your complaint with your local data protection authority.
          </p>
          <p>
            Please note that we may transfer, store and process your personal information outside the country you live in. Your personal information is also processed by staff and third party service providers and partners in these countries. If we transfer your personal information out of Europe, we will rely on recognized transfer mechanisms like the European Commission's Standard Contractual Clauses, unless the data transfer is to a country that has been determined to provide an adequate level of protection.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:rsskincare2016@gmail.com" className="text-black underline">rsskincare2016@gmail.com</a> or contact us at:
          </p>
          <address className="not-italic text-gray-700">
            11111 Nexus Avenue, 1379<br />
